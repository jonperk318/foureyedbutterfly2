  ...
  return (
    <div className={`w-full flex justify-center`}>
      ...
      >
        ...
        {postQuery.data && (
          <div
            className={`flex flex-col md:flex-row gap-8 w-full justify-between items-center`}
          >
            {postQuery.data.nextPost ? (
              <Link
                to={`/posts/${new Date(postQuery.data.nextPost.createdAt).getFullYear()}/${postQuery.data.nextPost.id}`}
                className={`text-secondary mr-auto md:mr-0`}
              >
            ...
            {postQuery.data.previousPost ? (
              <Link
                ...
                className={`text-secondary ml-auto md:ml-0`}
              >
