  ...
  return (
    <div className={`p-3 md:p-4`}>
      {mediaQuery.data ? (
        <>
          <div
            className={`flex flex-col md:flex-row justify-around md:justify-between items-center h-30 md:h-24`}
          >
            <h1 className={`text-sm lg:text-lg`}>
              Select the {mediaType} to place within this content block
            </h1>
            <IoReload
              ...
              >
                <span className={`indicator-item`}>
                  <input
                    ...
                    defaultChecked={content[index].data === file.name}
                  />
                </span>
                <Image
